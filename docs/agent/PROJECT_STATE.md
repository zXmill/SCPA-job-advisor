...
## Last Completed Task
`P1-PERF-001` - added content-hash invalidation for cached SBERT job embeddings in the pipeline encode stage. Commit pending.

## Next Task
Start `P1-PERF-002`: batch recommendation model scoring.
