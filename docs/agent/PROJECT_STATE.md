...
## Last Completed Task
`P1-PERF-002` - batched DQN rank policy-network scoring and tightened the NCF batch forward contract. Commit pending.

## Next Task
Start `P1-PERF-003`: add recommendation database indexes.
