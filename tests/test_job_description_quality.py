...
def test_realtime_scrape_quality_gate_requires_extracted_skill_signal() -> None:
    tag_only_job = _job_item(
        ...
        description=(
            "Support general office routines across departments, update internal "
            "notes, follow standard instructions, and keep daily work organized "
            "for multiple ongoing business initiatives in Indonesia."
        ),
        tags=["General"],
        company_logo=None,
