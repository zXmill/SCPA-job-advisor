...
const AnimationComponent: React.FC<AnimationComponentProps> = React.memo(
...
export function TextEffect({
  ...
  const finalContainerVariants: Variants = {
    hidden: containerVariants.hidden ?? defaultContainerVariants.hidden,
    visible: {
    ...
    exit: containerVariants.exit ?? defaultContainerVariants.exit,
  };
